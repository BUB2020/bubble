...
> 例：你在创世期内开始第一次挖矿，质押15个ETH，并同时投入了10,000个BUB，5天的ETH收益将为15 * 0.3% * 2 * 1.0 * 2.0 * 1.0 * 5 = 0.9个ETH，年化收益高达438%；如果第二回合选择继续复投，收益则为0.9 * 1.3=1.17个ETH，年化收益也会涨至569.4%。
...
> 例：你在创世期内开始第一次挖矿，质押15个ETH，并同时投入了10,000个BUB，5天后的收益将为10,000 * 5% * 2 * 1.0 * 1.0=1,000个BUB，年化收益高达730%。
...
> 例：你邀请了A，你质押了15个ETH和4万个BUB在挖矿，A在你挖矿期间也投入了15个ETH挖矿，每天收益0.2个ETH，那么，5天下来，你可以获得的邀请奖励为 50% * 0.2 * 5 * 1.0 * 1.2 = 0.6个ETH 以及 5,000个BUB。

# 奖池 
* 资金来源：ETH矿池入金的2%会自动划拨到奖池，合约部署20天后比例提高到3%，30天后为4%，40天后为5%。此外，有9百万个BUB会根据奖池余额分10轮释放，释放后的BUB会兑换成ETH充值进入奖池。
